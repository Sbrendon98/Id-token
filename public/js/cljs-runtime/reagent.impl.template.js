...
var G__22560 = o;
reagent.impl.template.goog$module$goog$object.set(G__22560,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__22561 = o;
reagent.impl.template.goog$module$goog$object.set(G__22561,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22562__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22563 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22563,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22563;
}
})(),id_class);
...
var vec__22566 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22566,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22566,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22566,(2),null);
...
var temp__5808__auto___22621 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___22621 == null)){
} else {
var key_22622 = temp__5808__auto___22621;
(jsprops.key = key_22622);
}
...
var temp__5808__auto___22623 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___22623 == null)){
} else {
var key_22624 = temp__5808__auto___22623;
...
var temp__5808__auto___22625 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___22625 == null)){
} else {
var key_22626 = temp__5808__auto___22625;
(jsprops.key = key_22626);
}
...
var temp__5808__auto___22631 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___22631 == null)){
} else {
var key_22632 = temp__5808__auto___22631;
...
var temp__5808__auto___22633 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___22633 == null)){
} else {
var key_22634 = temp__5808__auto___22633;
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22571_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22571_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22572 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22572,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22572,(1),null);
...
break;
default:
var G__22636 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__22637 = compiler;
v = G__22636;
compiler = G__22637;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template22599 = (function (opts,id,fn_to_element,parse_fn,meta22600){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22599.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22601,meta22600__$1){
var self__ = this;
var _22601__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22599(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22600__$1));
}));

(reagent.impl.template.t_reagent$impl$template22599.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22601){
var self__ = this;
var _22601__$1 = this;
return self__.meta22600;
}));

(reagent.impl.template.t_reagent$impl$template22599.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22599.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22599.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22599.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22599.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22599.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22600","meta22600",1319026071,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22599.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22599.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22599");

(reagent.impl.template.t_reagent$impl$template22599.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template22599");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22599.
 */
reagent.impl.template.__GT_t_reagent$impl$template22599 = (function reagent$impl$template$__GT_t_reagent$impl$template22599(opts,id,fn_to_element,parse_fn,meta22600){
return (new reagent.impl.template.t_reagent$impl$template22599(opts,id,fn_to_element,parse_fn,meta22600));
});
...
return (new reagent.impl.template.t_reagent$impl$template22599(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
