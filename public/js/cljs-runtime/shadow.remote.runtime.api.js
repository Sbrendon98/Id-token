...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_18821 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_18821(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_18822 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_18822(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_18823 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_18823(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_18824 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_18824(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_18825 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_18825(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_18830 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_18830(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__18819,callback){
var map__18820 = p__18819;
var map__18820__$1 = cljs.core.__destructure_map(map__18820);
var input = map__18820__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18820__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18820__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
