...
var G__16479 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__16479;
continue;
} else {
var G__16480 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__16480;
continue;
}
} else {
var G__16481 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__16481;
continue;
}
}
...
var G__16473 = zloc;
var G__16474 = (function (){var G__16475 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__16476 = zloc;
var G__16476__$1 = (((G__16476 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__16476) : rewrite_clj.zip.node.call(null,G__16476)));
if((G__16476__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__16476__$1) : zprint.zutil.edn_STAR_.call(null,G__16476__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__16475) : rewrite_clj.zip.root.call(null,G__16475));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__16473,G__16474) : rewrite_clj.zip.replace.call(null,G__16473,G__16474));
});
/**
...
var G__16482 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__16482;
continue;
}
break;
...
var G__16483 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__16484 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__16483;
out = G__16484;
continue;
} else {
...
var G__16485 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__16486 = cljs.core.next(new_loc);
var G__16487 = replaced_loc;
nloc = G__16485;
new_loc = G__16486;
last_loc = G__16487;
continue;
...
return zprint.rewrite.sort_val((function (){var G__16477 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__16477) : rewrite_clj.zip.down.call(null,G__16477));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__16478_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__16478_SHARP_) : rewrite_clj.zip.tag.call(null,p1__16478_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__16478_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__16478_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
