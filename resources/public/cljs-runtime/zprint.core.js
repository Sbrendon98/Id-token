...
var vec__17830 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__17833 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17833,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17833,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17830,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17830,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__17836){
var vec__17837 = p__17836;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17837,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17837,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17840,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17840,(1),null);
...
var vec__17844 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17844,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17844,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17844,(2),null);
var vec__17847 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17847,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17847,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17847,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__17851){
var vec__17852 = p__17851;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17852,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17852,(1),null);
...
var vec__17855 = tuple;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17855,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17855,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17855,(2),null);
...
var vec__17861 = cljs.core.first(style_vec);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17861,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17861,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17861,(2),null);
var tuple = vec__17861;
...
var G__17913 = cljs.core.next(style_vec);
var G__17914 = ends_w_blanks_QMARK_;
var G__17915 = tuple;
var G__17916 = (cljs.core.truth_(add_previous_to_out_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,previous_tuple):out);
style_vec = G__17913;
previous_ends_w_blanks_QMARK_ = G__17914;
previous_tuple = G__17915;
out = G__17916;
continue;
}
break;
...
var vec__17867 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17867,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17867,(1),null);
...
var result = (function (){var G__17870 = zprint.core.parse_string_all_options(rest_options);
var G__17871 = zprint.core.zprint_str_internal;
var G__17872 = ":parse-string-all? call";
var G__17873 = (function (){var G__17874 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__17874) : zprint.zutil.edn_STAR_.call(null,G__17874));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__17870,G__17871,G__17872,G__17873) : zprint.core.process_multiple_forms.call(null,G__17870,G__17871,G__17872,G__17873));
})();
if(cljs.core.truth_(new cljs.core.Keyword(null,"dbg?","dbg?",1845730771).cljs$core$IFn$_invoke$arity$1(rest_options))){
...
var vec__17875 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17875,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17875,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq17864){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__17865,G__17866,seq17864__$2);
}));
...
var args__5775__auto__ = [];
var len__5769__auto___17920 = arguments.length;
var i__5770__auto___17921 = (0);
while(true){
if((i__5770__auto___17921 < len__5769__auto___17920)){
args__5775__auto__.push((arguments[i__5770__auto___17921]));

var G__17922 = (i__5770__auto___17921 + (1));
i__5770__auto___17921 = G__17922;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq17879){
var G__17880 = cljs.core.first(seq17879);
var seq17879__$1 = cljs.core.next(seq17879);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__17880,seq17879__$1);
}));
...
var args__5775__auto__ = [];
var len__5769__auto___17923 = arguments.length;
var i__5770__auto___17924 = (0);
while(true){
if((i__5770__auto___17924 < len__5769__auto___17923)){
args__5775__auto__.push((arguments[i__5770__auto___17924]));

var G__17925 = (i__5770__auto___17924 + (1));
i__5770__auto___17924 = G__17925;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq17881){
var G__17882 = cljs.core.first(seq17881);
var seq17881__$1 = cljs.core.next(seq17881);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__17882,seq17881__$1);
}));
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq17883){
var G__17884 = cljs.core.first(seq17883);
var seq17883__$1 = cljs.core.next(seq17883);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__17884,seq17883__$1);
}));
...
var args__5775__auto__ = [];
var len__5769__auto___17929 = arguments.length;
var i__5770__auto___17930 = (0);
while(true){
if((i__5770__auto___17930 < len__5769__auto___17929)){
args__5775__auto__.push((arguments[i__5770__auto___17930]));

var G__17931 = (i__5770__auto___17930 + (1));
i__5770__auto___17930 = G__17931;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq17885){
var G__17886 = cljs.core.first(seq17885);
var seq17885__$1 = cljs.core.next(seq17885);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__17886,seq17885__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__17888,form){
var vec__17889 = p__17888;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17889,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17889,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17889,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17889,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__17892 = (cljs.core.truth_((function (){var and__5043__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__5043__auto__)){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17892,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17892,(1),null);
...
var G__17932 = cljs.core.next(sos);
var G__17933 = comment_QMARK_;
var G__17934 = (function (){var or__5045__auto__ = (!(empty_string_QMARK_));
if(or__5045__auto__){
return or__5045__auto__;
} else {
...
var G__17935 = ((empty_string_QMARK_)?out:((cljs.core.not(start_interpolating_QMARK_))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,s):(cljs.core.truth_(previous_comment_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,"\n"),s):cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,interpose_str),s)
)));
sos = G__17932;
previous_comment_QMARK_ = G__17933;
start_interpolating_QMARK_ = G__17934;
out = G__17935;
continue;
}
break;
...
try{var vec__17897 = zprint.core.remove_shebang(file_str);
var shebang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17897,(0),null);
var file_str__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17897,(1),null);
...
var vec__17900 = (cljs.core.truth_((function (){var or__5045__auto__ = range_start__$1;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return range_end__$1;
...
var actual_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17900,(0),null);
var actual_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17900,(1),null);
...
var vec__17903 = (cljs.core.truth_((function (){var and__5043__auto__ = actual_start;
if(cljs.core.truth_(and__5043__auto__)){
return actual_end;
} else {
return and__5043__auto__;
...
var before_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17903,(0),null);
var range = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17903,(1),null);
var after_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17903,(2),null);
...
var forms = (function (){var G__17906 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__17906) : zprint.zutil.edn_STAR_.call(null,G__17906));
})();
