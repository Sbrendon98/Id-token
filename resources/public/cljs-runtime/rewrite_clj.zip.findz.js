...
var len__5769__auto___16156 = arguments.length;
var i__5770__auto___16157 = (0);
while(true){
if((i__5770__auto___16157 < len__5769__auto___16156)){
args__5775__auto__.push((arguments[i__5770__auto___16157]));

var G__16158 = (i__5770__auto___16157 + (1));
i__5770__auto___16157 = G__16158;
continue;
} else {
}
break;
...
(rewrite_clj.zip.findz.tag_predicate.cljs$core$IFn$_invoke$arity$variadic = (function (t,p__16125){
var vec__16126 = p__16125;
var additional = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16126,(0),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__16122_SHARP_),t);
});
}
}));
...
/** @this {Function} */
(rewrite_clj.zip.findz.tag_predicate.cljs$lang$applyTo = (function (seq16123){
var G__16124 = cljs.core.first(seq16123);
var seq16123__$1 = cljs.core.next(seq16123);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16124,seq16123__$1);
}));

rewrite_clj.zip.findz.in_range_QMARK_ = (function rewrite_clj$zip$findz$in_range_QMARK_(p__16129,p__16130){
var map__16131 = p__16129;
var map__16131__$1 = cljs.core.__destructure_map(map__16131);
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16131__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16131__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var end_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16131__$1,new cljs.core.Keyword(null,"end-row","end-row",-545103581));
var end_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16131__$1,new cljs.core.Keyword(null,"end-col","end-col",-724155879));
var map__16132 = p__16130;
var map__16132__$1 = cljs.core.__destructure_map(map__16132);
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16132__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var c = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16132__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
...
return cljs.core.last(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__16135_SHARP_){
var and__5043__auto__ = (p_QMARK_.cljs$core$IFn$_invoke$arity$1 ? p_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__16135_SHARP_) : p_QMARK_.call(null,p1__16135_SHARP_));
if(cljs.core.truth_(and__5043__auto__)){
return rewrite_clj.zip.findz.in_range_QMARK_(cljs.core.meta(clojure.zip.node(p1__16135_SHARP_)),pos);
} else {
return and__5043__auto__;
}
...
var G__16140 = zloc;
var G__16140__$1 = (((G__16140 == null))?null:(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__16140) : f.call(null,G__16140)));
if((G__16140__$1 == null)){
return null;
} else {
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(G__16140__$1,f,p_QMARK_);
}
}));
...
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(zloc,f,(function (p1__16141_SHARP_){
...
return rewrite_clj.zip.findz.find_last_by_pos.cljs$core$IFn$_invoke$arity$3(zloc,pos,(function (p1__16146_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__16146_SHARP_),t);
}));
});
/**
...
var p_QMARK_ = ((cljs.core.set_QMARK_(v))?cljs.core.comp.cljs$core$IFn$_invoke$arity$2(v,rewrite_clj.zip.base.sexpr):(function (p1__16151_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.sexpr(p1__16151_SHARP_),v);
}));
