...
var G__12440 = devtools.prefs.pref(v);
v = G__12440;
continue;
} else {
return v;
...
}catch (e12405){var _e__11824__auto__ = e12405;
return false;
}})();
...
}catch (e12410){var _e__11824__auto__ = e12410;
return false;
}})();
...
}catch (e12413){var _e__11824__auto__ = e12413;
return false;
}}
}
});
...
var vec__12424 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12424,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12424,(1),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__12427_SHARP_);
}),template);
});
