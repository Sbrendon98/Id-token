...
if((c === "\n")){
var G__15977 = escape_QMARK_;
var G__15978 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__15977;
lines = G__15978;
continue;
} else {
buf.append(c);

var G__15979 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__15980 = lines;
escape_QMARK_ = G__15979;
lines = G__15980;
continue;
...
var G__15974 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__15974) : rewrite_clj.node.string_node.call(null,G__15974));
});
...
var G__15975 = cljs.core.re_pattern(regex);
var G__15976 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__15975,G__15976) : rewrite_clj.node.token_node.call(null,G__15975,G__15976));
});
