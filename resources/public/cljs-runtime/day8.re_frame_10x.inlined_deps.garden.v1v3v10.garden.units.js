 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.units.convert = (function day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$convert(p__13018,right){
var map__13019 = p__13018;
var map__13019__$1 = cljs.core.__destructure_map(map__13019);
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13019__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13019__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__13020 = temp__5804__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13020,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13020,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13020,(2),null);
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13106__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__13107 = u(y);
var map__13107__$1 = cljs.core.__destructure_map(map__13107);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13107__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3 = (function() { 
var G__13520__delegate = function (x,y,more){
...
while (G__13532__i < G__13532__a.length) {G__13532__a[G__13532__i] = arguments[G__13532__i + 2]; ++G__13532__i;}
  more = new cljs.core.IndexedSeq(G__13532__a,0,null);
} 
return G__13520__delegate.call(this,x,y,more);};
G__13520.cljs$lang$maxFixedArity = 2;
G__13520.cljs$lang$applyTo = (function (arglist__13534){
...
var G__13546 = null;
if (arguments.length > 2) {
var G__13547__i = 0, G__13547__a = new Array(arguments.length -  2);
while (G__13547__i < G__13547__a.length) {G__13547__a[G__13547__i] = arguments[G__13547__i + 2]; ++G__13547__i;}
G__13546 = new cljs.core.IndexedSeq(G__13547__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__13546);
}
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13108__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__13109 = u(y);
var map__13109__$1 = cljs.core.__destructure_map(map__13109);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13109__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 - m2));
});
...
var more = null;
if (arguments.length > 2) {
var G__13573__i = 0, G__13573__a = new Array(arguments.length -  2);
while (G__13573__i < G__13573__a.length) {G__13573__a[G__13573__i] = arguments[G__13573__i + 2]; ++G__13573__i;}
  more = new cljs.core.IndexedSeq(G__13573__a,0,null);
} 
...
var x = cljs.core.first(arglist__13574);
arglist__13574 = cljs.core.next(arglist__13574);
var y = cljs.core.first(arglist__13574);
...
while (G__13581__i < G__13581__a.length) {G__13581__a[G__13581__i] = arguments[G__13581__i + 2]; ++G__13581__i;}
G__13580 = new cljs.core.IndexedSeq(G__13581__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__13580);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13110__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__13111 = u(y);
var map__13111__$1 = cljs.core.__destructure_map(map__13111);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13111__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
...
while (G__13624__i < G__13624__a.length) {G__13624__a[G__13624__i] = arguments[G__13624__i + 2]; ++G__13624__i;}
  more = new cljs.core.IndexedSeq(G__13624__a,0,null);
} 
return G__13614__delegate.call(this,x,y,more);};
G__13614.cljs$lang$maxFixedArity = 2;
G__13614.cljs$lang$applyTo = (function (arglist__13626){
...
var G__13633 = null;
if (arguments.length > 2) {
var G__13634__i = 0, G__13634__a = new Array(arguments.length -  2);
while (G__13634__i < G__13634__a.length) {G__13634__a[G__13634__i] = arguments[G__13634__i + 2]; ++G__13634__i;}
G__13633 = new cljs.core.IndexedSeq(G__13634__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__13633);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var map__13128 = u(x);
var map__13128__$1 = cljs.core.__destructure_map(map__13128);
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13128__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__13130 = u(y);
var map__13130__$1 = cljs.core.__destructure_map(map__13130);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13130__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(m1,m2) : op.call(null,m1,m2)));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_divider_$_ud__3 = (function() { 
var G__13664__delegate = function (x,y,more){
...
var more = null;
if (arguments.length > 2) {
var G__13667__i = 0, G__13667__a = new Array(arguments.length -  2);
while (G__13667__i < G__13667__a.length) {G__13667__a[G__13667__i] = arguments[G__13667__i + 2]; ++G__13667__i;}
  more = new cljs.core.IndexedSeq(G__13667__a,0,null);
} 
return G__13664__delegate.call(this,x,y,more);};
G__13664.cljs$lang$maxFixedArity = 2;
G__13664.cljs$lang$applyTo = (function (arglist__13668){
...
return G__13664__delegate(x,y,more);
});
...
G__13670 = new cljs.core.IndexedSeq(G__13671__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__13670);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
