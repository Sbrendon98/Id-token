...
var G__16211 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__16211__$1 = (((G__16211 == null))?null:cljs.core.iterate((function (loc){
...
var G__16211__$2 = (((G__16211__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__16211__$1));
var G__16211__$3 = (((G__16211__$2 == null))?null:cljs.core.last(G__16211__$2));
if((G__16211__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__16211__$3);
}
} else {
return zloc;
}
...
var G__16214 = rewrite_clj.zip.move.right(v);
var G__16215 = rewrite_clj.zip.move.up(v);
loc = G__16214;
parent = G__16215;
continue;
} else {
var G__16216 = rewrite_clj.zip.move.right(v0);
var G__16217 = parent;
loc = G__16216;
parent = G__16217;
continue;
...
var G__16218 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__16219 = rewrite_clj.zip.move.up(v);
loc = G__16218;
parent = G__16219;
continue;
} else {
var G__16220 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__16221 = parent;
loc = G__16220;
parent = G__16221;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__16212 = zloc;
var G__16212__$1 = (((G__16212 == null))?null:rewrite_clj.zip.move.down(G__16212));
var G__16212__$2 = (((G__16212__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__16212__$1,k));
if((G__16212__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__16212__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__16213 = rewrite_clj.zip.move.down(zloc);
var G__16213__$1 = (((G__16213 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__16213));
if((G__16213__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__16213__$1);
}
})(),k);
}
});
