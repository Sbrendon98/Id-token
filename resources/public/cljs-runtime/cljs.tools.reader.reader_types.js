...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_12380 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_12380(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_12381 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_12381(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_12382 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_12382(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_12383 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_12383(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_12384 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_12384(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_12388 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_12388(reader);
}
});
...
var G__12403 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__12404 = s.append(c);
c = G__12403;
s = G__12404;
continue;
}
