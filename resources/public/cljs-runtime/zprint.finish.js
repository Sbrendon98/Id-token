...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__15389_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__15389_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__15389_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__15390){
var vec__15391 = p__15390;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15391,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15391,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__15394,s,color,element,idx){
var map__15395 = p__15394;
var map__15395__$1 = cljs.core.__destructure_map(map__15395);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15395__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15395__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15395__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__15398 = (function (){var or__5045__auto__ = color;
...
var fexpr__15397 = (function (){var G__15399 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__15399) : style_map.call(null,G__15399));
})();
return (fexpr__15397.cljs$core$IFn$_invoke$arity$1 ? fexpr__15397.cljs$core$IFn$_invoke$arity$1(G__15398) : fexpr__15397.call(null,G__15398));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__15400){
var vec__15401 = p__15400;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15401,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15401,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15401,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__15404){
var vec__15405 = p__15404;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15405,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15405,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15405,(2),null);
...
var G__15456 = cljs.core.next(ssv);
var G__15457 = (this_ssv == null);
var G__15458 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__15459 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__15456;
doing_nil_QMARK_ = G__15457;
last_elide = G__15458;
out = G__15459;
continue;
}
...
var vec__15411 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15411,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15411,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15411,(2),null);
...
var G__15460 = cljs.core.next(remaining_cvec);
var G__15461 = new_idx;
var G__15462 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__15460;
idx = G__15461;
out = G__15462;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__15418,cursor_vec){
var vec__15419 = p__15418;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15419,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15419,(1),null);
var focus_vec = vec__15419;
...
var vec__15422 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15422,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15422,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__15425){
var vec__15426 = p__15425;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15426,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15426,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__15432,existing_count){
var vec__15433 = p__15432;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15433,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15433,(1),null);
...
return cljs.core.filterv((function (p1__15429_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__15429_SHARP_))));
...
var vec__15439 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15439,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15439,(1),null);
var cvec_element = vec__15439;
if((cvec_element == null)){
var G__15470 = cljs.core.next(cvec_nl);
var G__15471 = (idx + (1));
var G__15472 = start;
var G__15473 = out;
cvec_nl = G__15470;
...
var G__15474 = cljs.core.next(cvec_nl);
var G__15475 = (idx + (1));
var G__15476 = idx;
var G__15477 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__15474;
idx = G__15475;
start = G__15476;
out = G__15477;
...
var G__15478 = cljs.core.next(cvec_nl);
var G__15479 = (idx + (1));
var G__15480 = (idx + (1));
var G__15481 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__15478;
idx = G__15479;
start = G__15480;
out = G__15481;
...
var G__15482 = cljs.core.next(cvec_nl);
var G__15483 = (idx + (1));
var G__15484 = idx;
var G__15485 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__15482;
idx = G__15483;
start = G__15484;
out = G__15485;
...
var G__15486 = cljs.core.next(cvec_nl);
var G__15487 = (idx + (1));
var G__15488 = start;
var G__15489 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__15486;
idx = G__15487;
start = G__15488;
out = G__15489;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__15443_SHARP_,p2__15442_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__15442_SHARP_)){
return cljs.core.reduced(p1__15443_SHARP_);
} else {
return (p1__15443_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__15444,p__15445){
var vec__15446 = p__15444;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15446,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15446,(1),null);
var vec__15449 = p__15445;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15449,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15449,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__15453,cvec,focus_vec){
var map__15454 = p__15453;
var map__15454__$1 = cljs.core.__destructure_map(map__15454);
var options = map__15454__$1;
var map__15455 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15454__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__15455__$1 = cljs.core.__destructure_map(map__15455);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15455__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15455__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15455__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__15452_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__15452_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
