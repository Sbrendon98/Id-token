...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__16168,k,f){
var vec__16169 = p__16168;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16169,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16169,(1),null);
var loc = vec__16169;
...
var G__16186 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__16186;
continue;
}
break;
...
var G__16187 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__16187;
continue;
} else {
return zloc__$1;
...
var G__16188 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__16188;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__16172){
...
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16176__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__16173;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__16177){
...
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16181__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__16178;
if(cljs.core.seq(r)){
...
var vec__16182 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16182,(0),null);
var map__16185 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16182,(1),null);
var map__16185__$1 = cljs.core.__destructure_map(map__16185);
var path = map__16185__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16185__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16185__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16185__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16185__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
