...
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.start_trace = (function day8$re_frame_10x$inlined_deps$re_frame$v1v1v2$re_frame$trace$start_trace(p__10956){
var map__10957 = p__10956;
var map__10957__$1 = cljs.core.__destructure_map(map__10957);
var operation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10957__$1,new cljs.core.Keyword(null,"operation","operation",-1267664310));
var op_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10957__$1,new cljs.core.Keyword(null,"op-type","op-type",-1636141668));
var tags = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10957__$1,new cljs.core.Keyword(null,"tags","tags",1771418977));
var child_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10957__$1,new cljs.core.Keyword(null,"child-of","child-of",-903376662));
...
var seq__10960_10987 = cljs.core.seq(cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.trace_cbs));
var chunk__10961_10988 = null;
var count__10962_10989 = (0);
var i__10963_10990 = (0);
while(true){
if((i__10963_10990 < count__10962_10989)){
var vec__10974_10991 = chunk__10961_10988.cljs$core$IIndexed$_nth$arity$2(null,i__10963_10990);
var k_10992 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10974_10991,(0),null);
var cb_10993 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10974_10991,(1),null);
try{var G__10978_10994 = cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces);
(cb_10993.cljs$core$IFn$_invoke$arity$1 ? cb_10993.cljs$core$IFn$_invoke$arity$1(G__10978_10994) : cb_10993.call(null,G__10978_10994));
}catch (e10977){var e_10995 = e10977;
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error thrown from trace cb",k_10992,"while storing",cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces),e_10995], 0));
}

var G__10996 = seq__10960_10987;
var G__10997 = chunk__10961_10988;
var G__10998 = count__10962_10989;
var G__10999 = (i__10963_10990 + (1));
seq__10960_10987 = G__10996;
chunk__10961_10988 = G__10997;
count__10962_10989 = G__10998;
i__10963_10990 = G__10999;
continue;
} else {
var temp__5804__auto___11000 = cljs.core.seq(seq__10960_10987);
if(temp__5804__auto___11000){
var seq__10960_11001__$1 = temp__5804__auto___11000;
if(cljs.core.chunked_seq_QMARK_(seq__10960_11001__$1)){
var c__5568__auto___11002 = cljs.core.chunk_first(seq__10960_11001__$1);
var G__11003 = cljs.core.chunk_rest(seq__10960_11001__$1);
var G__11004 = c__5568__auto___11002;
var G__11005 = cljs.core.count(c__5568__auto___11002);
var G__11006 = (0);
seq__10960_10987 = G__11003;
chunk__10961_10988 = G__11004;
count__10962_10989 = G__11005;
i__10963_10990 = G__11006;
continue;
} else {
var vec__10979_11007 = cljs.core.first(seq__10960_11001__$1);
var k_11008 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10979_11007,(0),null);
var cb_11009 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10979_11007,(1),null);
try{var G__10983_11010 = cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces);
(cb_11009.cljs$core$IFn$_invoke$arity$1 ? cb_11009.cljs$core$IFn$_invoke$arity$1(G__10983_11010) : cb_11009.call(null,G__10983_11010));
}catch (e10982){var e_11011 = e10982;
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error thrown from trace cb",k_11008,"while storing",cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces),e_11011], 0));
}

var G__11012 = cljs.core.next(seq__10960_11001__$1);
var G__11013 = null;
var G__11014 = (0);
var G__11015 = (0);
seq__10960_10987 = G__11012;
chunk__10961_10988 = G__11013;
count__10962_10989 = G__11014;
i__10963_10990 = G__11015;
continue;
}
} else {
}
