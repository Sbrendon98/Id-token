...
var G__12526 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__12526;
continue;
} else {
return ch;
...
var vec__12510 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12510,(0),null);
return (match === s);
});
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq12520){
...
return (function() { 
var G__12534__delegate = function (rdr,_){
...
var G__12534 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__12535__i = 0, G__12535__a = new Array(arguments.length -  1);
while (G__12535__i < G__12535__a.length) {G__12535__a[G__12535__i] = arguments[G__12535__i + 1]; ++G__12535__i;}
  _ = new cljs.core.IndexedSeq(G__12535__a,0,null);
} 
return G__12534__delegate.call(this,rdr,_);};
G__12534.cljs$lang$maxFixedArity = 1;
G__12534.cljs$lang$applyTo = (function (arglist__12536){
var rdr = cljs.core.first(arglist__12536);
var _ = cljs.core.rest(arglist__12536);
return G__12534__delegate(rdr,_);
});
