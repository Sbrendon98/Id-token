...
return [(function (){var pred__10443 = cljs.core.instance_QMARK_;
var expr__10444 = reactive_val;
if(cljs.core.truth_((pred__10443.cljs$core$IFn$_invoke$arity$2 ? pred__10443.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__10444) : pred__10443.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__10444)))){
return "ra";
} else {
if(cljs.core.truth_((pred__10443.cljs$core$IFn$_invoke$arity$2 ? pred__10443.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__10444) : pred__10443.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__10444)))){
return "rc";
} else {
if(cljs.core.truth_((pred__10443.cljs$core$IFn$_invoke$arity$2 ? pred__10443.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__10444) : pred__10443.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__10444)))){
return "rx";
} else {
if(cljs.core.truth_((pred__10443.cljs$core$IFn$_invoke$arity$2 ? pred__10443.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__10444) : pred__10443.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__10444)))){
return "tr";
} else {
return "other";
}
