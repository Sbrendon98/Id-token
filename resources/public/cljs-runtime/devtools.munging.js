...
var o13844 = temp__5802__auto__;
var temp__5802__auto____$1 = (o13844["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o13845 = temp__5802__auto____$1;
return (o13845["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__11503__auto__ = f;
return (o__11503__auto__["toString"]).call(o__11503__auto__);
} else {
return "";
}
}catch (e13846){var _ = e13846;
return "";
}});
...
try{var o__11503__auto___14055 = t;
(o__11503__auto___14055["cljs$lang$ctorPrWriter"]).call(o__11503__auto___14055,t,writer);
}catch (e13847){var __14056 = e13847;
}
...
var char_code = (function (){var o__11503__auto__ = (new String(char$));
return (o__11503__auto__["charCodeAt"]).call(o__11503__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__11503__auto__ = String;
return (o__11503__auto__["fromCharCode"]).call(o__11503__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__13852 = num_code;
switch (G__13852) {
case (1):
return (185);
...
var o__11503__auto__ = String;
return (o__11503__auto__["fromCharCode"]).call(o__11503__auto__,superscript_code);
});
/**
...
}catch (e13876){var _e__11555__auto__ = e13876;
return false;
}})())){
...
var vec__13877 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13877,(0),null);
...
var len__5769__auto___14061 = arguments.length;
var i__5770__auto___14062 = (0);
while(true){
if((i__5770__auto___14062 < len__5769__auto___14061)){
args__5775__auto__.push((arguments[i__5770__auto___14062]));

var G__14063 = (i__5770__auto___14062 + (1));
i__5770__auto___14062 = G__14063;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__13889){
var vec__13890 = p__13889;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13890,(0),null);
...
var G__14064 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__14065 = cljs.core.butlast(remaining_tokens);
name_tokens = G__14064;
remaining_tokens = G__14065;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq13887){
var G__13888 = cljs.core.first(seq13887);
var seq13887__$1 = cljs.core.next(seq13887);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13888,seq13887__$1);
}));
...
var vec__13895 = cljs.core.split_with((function (p1__13894_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__13894_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13895,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13895,(1),null);
...
var vec__13902 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13902,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13902,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__14068 = cljs.core.rest(remaining_tokens);
var G__14069 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__14068;
...
var vec__13907 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13907,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13907,(1),null);
var vec__13910 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13910,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13910,(1),null);
var vec__13913 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13913,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13913,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13913,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13913,(3),null);
...
var vec__13918 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13918,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13918,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13918,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13918,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13918,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13918,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__13922 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13922,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13922,(1),null);
var vec__13925 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13925,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13925,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__13928 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__13928) : devtools.munging.parse_fn_info_deep.call(null,G__13928));
})()));
}
} else {
return fn_info;
...
var G__14077 = (arity + (1));
var G__14078 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__13949){
var vec__13950 = p__13949;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13950,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13950,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13966_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__13966_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13967_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__13967_SHARP_);
}),sorted_infos);
...
var args__5775__auto__ = [];
var len__5769__auto___14089 = arguments.length;
var i__5770__auto___14090 = (0);
while(true){
if((i__5770__auto___14090 < len__5769__auto___14089)){
...
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13971,(0),null);
...
var map__13997 = options;
var map__13997__$1 = cljs.core.__destructure_map(map__13997);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13997__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13997__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13997__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13997__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__13998 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13998,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13998,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13998,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13998,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13998,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13998,(5),null);
...
var o__11503__auto__ = f;
return (o__11503__auto__["getBasis"]).call(o__11503__auto__);
});
/**
...
}catch (e14009){var _e__11555__auto__ = e14009;
...
var G__14105 = (obj[cljs.core.first(path)]);
var G__14106 = cljs.core.rest(path);
obj = G__14105;
path = G__14106;
continue;
} else {
...
var _STAR_ = (function (accum,p__14028){
var vec__14029 = p__14028;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14029,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14029,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__14041){
var vec__14042 = p__14041;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14042,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14042,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14042,(2),null);
...
var post_process = (function (p__14050){
var vec__14051 = p__14050;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14051,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14051,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__14045_SHARP_){
return (obj[cljs.core.first(p1__14045_SHARP_)]);
}),sorted_matches);
