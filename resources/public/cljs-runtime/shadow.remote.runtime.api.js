...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_16919 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_16919(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_16920 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_16920(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_16921 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_16921(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_16926 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_16926(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_16934 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_16934(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_16938 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_16938(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__16915,callback){
var map__16916 = p__16915;
var map__16916__$1 = cljs.core.__destructure_map(map__16916);
var input = map__16916__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16916__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16916__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
