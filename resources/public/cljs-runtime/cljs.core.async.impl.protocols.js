...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_15094 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_15094(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_15099 = (function (port,val,fn1_handler){
var x__5393__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_15099(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_15100 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_15100(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_15101 = (function (chan){
var x__5393__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_15101(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_15102 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_15102(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_15103 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_15103(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_15110 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_15110(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_15119 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_15119(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_15120 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_15120(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_15121 = (function (b,itm){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_15121(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_15122 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_15122(b);
}
});
