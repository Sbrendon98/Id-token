...
var G__22630 = o;
reagent.impl.template.goog$module$goog$object.set(G__22630,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__22648__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__22648 = function (var_args){
var args = null;
...
return G__22648__delegate.call(this,args);};
G__22648.cljs$lang$maxFixedArity = 0;
G__22648.cljs$lang$applyTo = (function (arglist__22650){
var args = cljs.core.seq(arglist__22650);
return G__22648__delegate(args);
});
...
var G__22631 = o;
reagent.impl.template.goog$module$goog$object.set(G__22631,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__22632 = props;
var G__22632__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22632,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22632);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22632__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22633 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22633,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22633;
}
})(),id_class);
...
var G__22634 = (cljs.core.count(argv) - first_child);
switch (G__22634) {
case (0):
...
var vec__22635 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22635,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22635,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22635,(2),null);
...
var temp__5808__auto___22669 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___22669 == null)){
} else {
var key_22670 = temp__5808__auto___22669;
(jsprops.key = key_22670);
}
...
var temp__5808__auto___22672 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___22672 == null)){
} else {
var key_22674 = temp__5808__auto___22672;
(jsprops.key = key_22674);
}
...
var temp__5808__auto___22679 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___22679 == null)){
} else {
var key_22680 = temp__5808__auto___22679;
(jsprops.key = key_22680);
}
...
var temp__5808__auto___22690 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___22690 == null)){
} else {
var key_22691 = temp__5808__auto___22690;
...
var temp__5808__auto___22692 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___22692 == null)){
} else {
var key_22694 = temp__5808__auto___22692;
(jsprops.key = key_22694);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22638_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22638_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22639 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22639,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22639,(1),null);
...
break;
default:
var G__22711 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__22712 = compiler;
v = G__22711;
compiler = G__22712;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template22645 = (function (opts,id,fn_to_element,parse_fn,meta22646){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22645.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22647,meta22646__$1){
var self__ = this;
var _22647__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22645(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22646__$1));
}));

(reagent.impl.template.t_reagent$impl$template22645.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22647){
var self__ = this;
var _22647__$1 = this;
return self__.meta22646;
}));

(reagent.impl.template.t_reagent$impl$template22645.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22645.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22645.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22645.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22645.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22645.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22646","meta22646",-1652975686,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22645.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22645.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22645");

(reagent.impl.template.t_reagent$impl$template22645.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template22645");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22645.
 */
reagent.impl.template.__GT_t_reagent$impl$template22645 = (function reagent$impl$template$__GT_t_reagent$impl$template22645(opts,id,fn_to_element,parse_fn,meta22646){
return (new reagent.impl.template.t_reagent$impl$template22645(opts,id,fn_to_element,parse_fn,meta22646));
});
...
return (new reagent.impl.template.t_reagent$impl$template22645(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
